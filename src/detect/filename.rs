...
pub(crate) static FILENAME: Map<&'static str, FileTypeResolver> = phf_map! {
    ...
    "xorg.conf" => FileTypeResolver::Dynamic(detect::xfree86),
    "xorg.conf-4" => FileTypeResolver::Dynamic(detect::xfree86),
    ...
    "tmux.conf" => FileTypeResolver::Static(FileType::Sh),
    ".sh_history" => FileTypeResolver::Static(FileType::Sh),
    ".bash_login" => FileTypeResolver::Static(FileType::Sh),
    ".zimrc" => FileTypeResolver::Static(FileType::Sh),
    "bash_completion" => FileTypeResolver::Static(FileType::Sh),
    ".Renviron" => FileTypeResolver::Static(FileType::Sh),
    ".xsession" => FileTypeResolver::Static(FileType::Sh),
    ".xsessionrc" => FileTypeResolver::Static(FileType::Sh),
    ".yashrc" => FileTypeResolver::Static(FileType::Sh),
    ".yash_profile" => FileTypeResolver::Static(FileType::Sh),
    ".hushlogin" => FileTypeResolver::Static(FileType::Sh),
    ".xinitrc" => FileTypeResolver::Static(FileType::Sh),
    "xinitrc" => FileTypeResolver::Static(FileType::Sh),
    ".xserverrc" => FileTypeResolver::Static(FileType::Sh),
    "xserverrc" => FileTypeResolver::Static(FileType::Sh),
    ...
    "{t,j}sconfig.json" => FileTypeResolver::Static(FileType::JsonC),
