...
pub(crate) const PATH_SUFFIX: &[(&str, FileTypeResolver)] = &[
    ...
    (".git/config", FileTypeResolver::Static(FileType::GitConfig)),
    (".config/git/config", FileTypeResolver::Static(FileType::GitConfig)),
    ("{app,addon}/{components,templates}/*.hbs", FileTypeResolver::Static(FileType::Handlebars)),
    ("templates/*.yaml", FileTypeResolver::Static(FileType::Helm)),
    ("templates/*.yml", FileTypeResolver::Static(FileType::Helm)),
    ("templates/_*.tpl", FileTypeResolver::Static(FileType::Helm)),
    ("templates/NOTES.txt", FileTypeResolver::Static(FileType::Helm)),
    ("**/src/*/resources/**/*.conf", FileTypeResolver::Static(FileType::Hocon)),
    ("hypr/*.conf", FileTypeResolver::Static(FileType::Hyprlang)),
    (".aws/config", FileTypeResolver::Static(FileType::ConfIni)),
    (".pytest_cache/v/cache/*", FileTypeResolver::Static(FileType::Json)),
    (".vscode/*.json", FileTypeResolver::Static(FileType::JsonC)),
    ("sites-available/*.conf", FileTypeResolver::Static(FileType::Nginx)),
    ("sites-enabled/*.conf", FileTypeResolver::Static(FileType::Nginx)),
    ("conf.d/*.conf", FileTypeResolver::Static(FileType::Nginx)),
    ("kanshi/config", FileTypeResolver::Static(FileType::Scfg)),
    ("containers.conf.d/*.conf", FileTypeResolver::Static(FileType::Toml)),
    ("containers.conf.modules/*.conf", FileTypeResolver::Static(FileType::Toml)),
    (".gem/credentials", FileTypeResolver::Static(FileType::Yaml)),
    (".kube/config", FileTypeResolver::Static(FileType::Yaml)),
    (".kube/kuberc", FileTypeResolver::Static(FileType::Yaml)),
];
